...
public class SubscriptionState {
    ...
    /**
     * NONE ： 默认值
     * AUTO_TOPICS： subscribe 之后
     * USER_ASSIGNED： assign 之后
     */
    ...
    // subscribe 采用的是 Pattern 时 所传入的 Pattern
    private Pattern subscribedPattern;

    /* the list of topics the user has requested */
    // subscribe : consumer 订阅的 topic
    private Set<String> subscription;

    /* the list of topics the group has subscribed to (set only for the leader on join group completion) */
    // subscribe : consumer 订阅的所有的 topic
    ...
    // subscribe: 如果 user 写了 ConsumerRebalanceListener 则有，否则为 空
...
//        System.out.println(this.subscriptionType);
