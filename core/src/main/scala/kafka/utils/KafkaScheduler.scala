...
class KafkaScheduler(val threads: Int, 
  ...
  /**
    *
    * @param name The name of this task  任务名称
    * @param fun   任务
    * @param delay The amount of time to wait before the first execution  延迟
    * @param period The period with which to execute the task. If < 0 the task will execute only once.  任务的调度频率
    * @param unit The unit for the preceding times.   时间单位（秒、分、时）
    */
